...
class DocumentsCreateNewRequest extends FormRequest {
    ...
    public function rules() {
        return [
            ...
            'resolucion_acta_homologacion' => 'nullable|mimes:application/pdf, application/x-pdf,application/acrobat, applications/vnd.pdf, text/pdf, text/x-pdf',
            'certificado_notas' => 'nullable|mimes:application/pdf, application/x-pdf,application/acrobat, applications/vnd.pdf, text/pdf, text/x-pdf',
            'contenidos_tematicos' => 'nullable|mimes:application/pdf, application/x-pdf,application/acrobat, applications/vnd.pdf, text/pdf, text/x-pdf',
    ...
    public function messages() {
        return [
            ...
            'resolucion_acta_homologacion.file' => 'El campo ' . __('documentos.resolucion_acta_homologacion') . ' debe contener un archivo de formato PDF.',
            ...
            'carnet_vacunas.mimes' => 'El campo ' . __('documentos.carnet_vacunas') . ' debe contener un archivo de formato PDF.',
        ];
    }
