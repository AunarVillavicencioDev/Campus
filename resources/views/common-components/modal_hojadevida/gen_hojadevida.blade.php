                ...
                <div class="row justify-content-center">
                    <div class="col-xl-12 ">
                        <div class="row align-items-start justify-content-center">
                            {!! Form::open(['route' => 'hv.store', 'method' => 'post']) !!}
                            <div class="col-xl-2 ">
                                <div class="row">
                                    <p><b> Nombre </b></p>
                                    <p> {{$nombre}}</p>
                            ...
                            <div class="col-xl-10">
                                {!! Form::label('correciones', "Cargar Operaciones");!!}
                    ...
                    <div class="row justify-content-end" style="padding-top:20px;">
                        <div class="col-xl-2">
                            <a href="#"><button style="font-size: 18px;" type="button" class="btn btn-danger ">Correcciones </button></a>
                        </div>
                        <div class="col-xl-2">
                            {{ Form::button('Valida HV OK', ['type' => 'submit', 'class' => 'btn btn-primary btn-lg waves-effect waves-light '] )  }}
                            {!! Form::close() !!} 
                        </div>
                    </div>
                </div>
