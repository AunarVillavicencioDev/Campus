                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    {{ Form::select('genero', ['H'=>'Hombre', 'M'=>'Mujer'], @old('genero'), ['class' => 'form-control', 'placeholder' => 'Selecione una opcion']) }}
                                </div>
                            </div>
                        </div>
                    </section>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            ...
                                            {{ Form::hidden('periodo_academico', $now, @old('periodo_academico'), ['class' => 'form-control']) }}
                                        </div>
                                    </div>
                                </div>
                            </div>
