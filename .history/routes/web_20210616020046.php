...
Route::get('/vermigestion', [App\Http\Controllers\admin\MigestionController::class, 'index'])->name('vermigestion.index');
Route::get('/reportematriculas', [App\Http\Controllers\admin\ReportematriculasController::class, 'index'])->name('reportematriculas.index');
