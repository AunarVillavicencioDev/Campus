            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="dt-buttons btn-group flex-wrap">  
                        ...
                        <div class="row">
                        <div class="col-sm-12 col-md-6" id="ocultar3"><div id="datatable-buttons_filter" class="dataTables_filter"><label>Search:<input type="search" class="form-control form-control-sm" placeholder="" aria-controls="datatable-buttons"></label></div></div></div></div>
