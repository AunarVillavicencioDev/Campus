    ...
    <div class="col-xl-12 ">
        <div class="card">
            <div class="card-body">
                <div class="row align-items-start justify-content-center">
                    <div class="row">
                    {!! Form::open(['route' => 'admin.oportunidad.oportunidad']) !!}
                    ...
                    <div class="row">
                        ...
                        {!!  Form::select('Tipo_de_Solicitud_Selecion', ['1' => 'Llamar de nuevo', '2' => 'xxxxx'], $typeForm, ['class' => 'form-control form-control-lg', 'id'=>'Tipo_de_Solicitud_Selecion']); !!}
                           </div> 
                        </div>
                    </div>
                    <div class="row">
