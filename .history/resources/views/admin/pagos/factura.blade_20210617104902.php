                            ...
                            <tr> <td> <br> </td> <tr>
                                <tr>    
                                    <td  colspan="2" scope="row">
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <th  class="table-active" scope="row">Fecha   </th>
                                                                        <td>16-06-2021</td>
                                                                        <th   class="table-active" scope="row">Estudiantes  </th>
                                                                        <td>Pepito Perez Peps Pops</td>
                                                                    </tr>
                                                                    <tr>
                                                                    <th  class="table-active" scope="row">Identificacion  </th>
                                                                        <td>123456789s   </td>
                                                                        <th   class="table-active" scope="row">Direccion  </th>
                                                                        <td>calle 40 #20 - 32, jordan</td>
                                                                    </tr>
                                                                    <tr>
                                                                   <th class="table-active" scope="row">Programa  </th>
                                                                        <td>Ingenieria Informatica  </td>
                                                                        <th   class="table-active" scope="row">Jornada </th>
                                                                        <td>Diurna</td>
                                                                    </tr>
                                                                </tbody>
                                                                </table>
                                ...
                                <tr>
                                    <th   colspan="2" scope="row">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td colspan="3"   scope="row"> Profesional en Ingenieria Informatica cod 123456 </th>
                                                                        <td    scope="row"> $400.000 </th>
                                                                    </tr>
                                                                </tbody>
                                                                </table> </th>
                                    <td></td>
                                ...
                                <tr>
                                    <th colspan="2" scope="row">  <table class="table  mb-0">
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td colspan="2" scope="row"> PAGO ORDINARIO </th>
                                                                        <td    scope="row"> 31/05/2021 </th>
                                                                        <td    scope="row"> $400.000 </th>
                                                                    </tr>
                                                                </tbody>
                                                                </table> </th>
                                ...
                                <tr>
                                    <th colspan="2" scope="row">  <table class="table  mb-0">
                                                                <tbody>
                                                                    ...
                                                                    <tr> <td> <br> </td> <tr>
                                                                    <tr>
                                                                        <td colspan="3" scope="row" style="text-align: right;"> Cheque </th>
                                                                        <td    scope="row">  </th>
                                                                    </tr>
                                                                    <tr>
                                                                        <td colspan="3" scope="row" style="text-align: right;"> Efectivo </th>
                                                                        <td    scope="row">  </th>
                                                                    </tr>
                                                                </tbody>
                                                                </table> </th>
                                ...
                                <tr> <td> <br> </td> <tr>
                                <tr>
                                    <th colspan="2" scope="row">  <table class="table-bordered  mb-0">
                                                                <tbody>
                                                                    <tr>
                                                                        <td colspan="2"   scope="row" style="text-align: right;"> HASTA 31/05/2021 </th>
                                                                        <td    scope="row"> TOTAL A PAGAR </th>
                                                                        <td    scope="row">$400.000 </th>
                                                                    </tr>
                                                                    <tr>
                                                                        <td colspan="4"   scope="row" style="text-align: center;"> CODIGO DE BARRAS </th>
                                                                    </tr>
                                                                </tbody>
                                                                </table> </th>
                                    <td></td>
