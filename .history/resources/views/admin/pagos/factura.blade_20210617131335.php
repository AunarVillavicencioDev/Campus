...
$codigolargo = "(415)7709998742406(8020)07001121965804017810(3900)00015100(96)20210115";
                                ...
                                <tr>
                                    <th colspan="2" scope="row">  <table class="table mb-0">
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td colspan="4"   scope="row" style="text-align: center;"> <p id="codigodebarras"> {{$codigolargo}}</p> </td>
                                                                    </tr>
                                                                </tbody>
                                                                </table> </th>
                                    <td></td>
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td colspan="2"  style="text-align: right;">
                                                                            <img  width="150" height="50"src="http://asojuegos.co/wp-content/uploads/2018/12/logo_pie_consuerte.png">
                                                                            <img  width="150" height="75"src="http://assets.stickpng.com/images/5a270db16c723e0970203ea9.png">
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td colspan="2"   scope="row" style="text-align:left;"> 
                                                                        ...
                                                                        <td colspan="2"  style="text-align: right;"><img  width="100" height="100"src="https://www.homecenter.com.co/static/landing/PSE/img/PSE.png">
                                                                        <img  width="150" height="70"src="http://uniemprendia.es/wp-content/uploads/2018/10/Visa-MasterCard-1024x393.png"></td></td>
                                                                    </tr>
                                                                </tbody>
                                                                </table> </th>
                                    <td></td>
