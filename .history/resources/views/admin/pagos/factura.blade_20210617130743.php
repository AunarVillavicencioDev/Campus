                                    ...
                                    <th colspan="2" scope="row">  <table class="table mb-0" id="mediosdepago">
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td colspan="2"  style="text-align: right;"><img  width="150" height="50"src="http://asojuegos.co/wp-content/uploads/2018/12/logo_pie_consuerte.png">
                                                                        <img  width="150" height="75"src="http://assets.stickpng.com/images/5a270db16c723e0970203ea9.png"></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td colspan="2"   scope="row" style="text-align:left;"> 
