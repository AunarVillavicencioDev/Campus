                            ...
                            <tr><td><br></td></tr>
                                ...
                                <tr>
                                    <th colspan="2" scope="row">  <table class="table mb-0" id="mediosdepago">
                                                                <tbody>
                                                                    <tr>
                                                                        <td colspan="2"   scope="row" style="text-align: left;"> Medios de Pago </td>
                                                                    </tr>
                                                                    <tr> <td> <br> </td> </tr>
                                                                    <tr>
                                                                        <td colspan="4"   scope="row" style="text-align: left;"> 1.Banco BBVA CTA ahorros No 957534852 </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td colspan="4"   scope="row" style="text-align: left;"> 2.Tarjetas de crédito MasterCard, Visa y American Express en linea </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td colspan="4"   scope="row" style="text-align: left;"> 3.Consuerte </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td colspan="4"   scope="row" style="text-align:left;"> 4.PSE  -https://www.zonapagos.com/t_aunar/pagos.asp  </td>
                                                                    </tr>
                                                                    <tr> <td> <br> </td> </tr>
                                                                    <tr>
                                                                        <td colspan="4"   scope="row" style="text-align:left;"> EN CASO DE NO CUMPLIR CON LOS REQUISITOS PARA GRADO</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td colspan="4"   scope="row" style="text-align:left;"> ABSTENERSE DE PAGAR; SI LOS CANCELO, ESTOS VALORES NO SERAN</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td colspan="4"   scope="row" style="text-align:left;"> CAUSAL DE DEVOLUCIÓN, SE SOSTIENE HASTA POR UN AÑO.</td>
                                                                    </tr>
                                                                </tbody>
                                                                </table> </th>
                                    <td></td>
