                                ...
                                <tr>
                                    <th colspan="2" scope="row">  <table class="table mb-0" id="mediosdepago">
                                                                <tbody>
                                                                    ...
                                                                    <tr> <td> <br> </td> </tr>
                                                                    <tr>
                                                                        <td colspan="4"   scope="row" style="text-align: center;"> 1.Banco BBVA CTA ahorros No 957534852 </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td colspan="4"   scope="row" style="text-align: center;"> 2.Tarjetas de crédito MasterCard, Visa y American Express en linea </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td colspan="4"   scope="row" style="text-align: center;"> 3.Consuerte </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td colspan="4"   scope="row" style="text-align: center;"> 4.PSE  -https://www.zonapagos.com/t_aunar/pagos.asp  </td>
                                                                    </tr>
                                                                </tbody>
                                                                </table> </th>
                                    <td></td>
